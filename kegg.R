...
denrogramma <- tanglegram ( hc1, hc2)

png("дендр.png", width = 12, height = 15, res = 300, units = "cm")
plot(tanglegram ( hc1, hc2, lab.cex = 0.7))
dev.off()
...
x <- c(str_split("AKT1, ATM, ATR, BAP1, BARD1, BRCA1, BRCA2, BRIP1, CDK12, CHEK1, CHEK2, CTNNB1, ERCC4, FANCA, FANCE,
FANCI, KRAS, MLH1, MRE11, MSH2, MSH6, MUTYH, NBN, PALB2, PARP1, PIK3CA, PPP2R2A, PTEN, RAD50, RAD51, RAD51B, RAD51C, 
RAD51D, RAD52, RAD54B, RAD54L, TP53, TP53BP1, XRCC2, XRCC3", ", ", simplify = T))
